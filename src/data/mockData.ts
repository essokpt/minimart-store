...
export const products: Product[] = [
  {
    ...
    category_id: 'c1',
    category: { category_id: 'c1', name: 'Beverages' },
    cost_price: 1.0,
    unit_price: 1.85,
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAiSVmFigMTxE6oCnnoLszxfcLUKKTQ4D_e-Ci-hgyXVQiqB589vrSrFCgfVtvJZVnukUhqsfE9uMiP3XaYbFbi7wOdVptsGkeIcFHX1aUd6Y4J_2plFJXc-gVOKK5OuddIFWf8P_j2PeP5fudT7H960Jz4xN9RyEO3GXWFYip3CGz6aNHLpG-l7XOx3ynyQJWCY_2HIZSDSgRQaUDB-vKorncmJFZ6SiGepMO6SRZNNxON0DcMlBYtOOF1QRQ9sXnNFQ2R4Xwz-iU'
  },
  {
    product_id: '2',
    name: 'Artisan Cupcake',
    category_id: 'c2',
    category: { category_id: 'c2', name: 'Bakery' },
    cost_price: 1.25,
    unit_price: 3.5,
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAD8NLV3Vyva-ApxiGqQV_P17FRbctpdjcQMzlW_M8UqmRUiGLoXeTrFB6YtJkNc4egvNhOXSOhGbs6AzUxMVtYOTA9x8p8p_4LEQX3bPn0k96qqt5vu6HKv6-kbojoh1cpdZMkHpewz2jAh-sXAo69XryfAsSQV3j3bZD_Elu5C9LG2PxL3-usbQNRfnnxSGQ5sXAOrEJUYpxTeisrYsVtxMwxU_FKzj2ZgDgv_Xi_gZc3_el9gz1O9F7XVzG0UF4sxhOfR9c5xbU'
  },
  {
    product_id: '3',
    name: 'Sea Salt Chips 150g',
    category_id: 'c3',
    category: { category_id: 'c3', name: 'Snacks' },
    cost_price: 0.9,
    unit_price: 2.2,
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDGXORq1fqxHkC4rZQQm1Jfplo6UQIfEm8NupuHr6FQAybseACXFaddzDgWo4XsAOMxyrsWCfTiN94WPhYt00NU7KAtH7-oTa-9q9Vtgt9c9vRC4wY4CRS4uBaHBe5x-HkhqL674QvlYRJ9PrAPHf41KewE8IUgJ2kZamtlERWNMlH00IW7IHAKB3jt1CnglzNuQT2YFsdhkDh0oJu-8VS6TCZMT2n92w50UtB5SQom2lubwFmAxqID48ap9DDMbc-_jccO9eINmpY'
  },
  {
    product_id: '4',
    name: 'Whole Milk 1L',
    category_id: 'c4',
    category: { category_id: 'c4', name: 'Dairy & Eggs' },
    cost_price: 0.8,
    unit_price: 1.45,
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuADrxThvqR05u55ktKUmORd-TMZSTZTzFnKr4Icq88wOc8gUks7HTNbXsLR9UXTa9-93pBbVA6yluDm3ZqvBHId_LTQuZt_qaA_XN0_1BTTdbwdoSyKdLLvAyV0aceKOLkduDAQagOiAShF-jXkuXhkvjkzDvAhpvWxuqEXHNoYKyYJlblwREd4tiB5zGno6uUAH9hlEJZBf8lXgN6V4Z_fj4wKMz2FHQMlOulvHORvu9NOlhlgCCjH-SDA34GHizXr9mhJguGLRxA'
  },
  {
    product_id: '5',
    name: 'Green Apples (kg)',
    category_id: 'c5',
    category: { category_id: 'c5', name: 'Produce' },
    cost_price: 2.5,
    unit_price: 4.2,
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCxJ3lQ3MyttQeFs5Le9UyOO-ji76XgLOqdVv_JOd1GxbBYjNe_jqIbVKvvF_OWAIPnT81yn2w92qidFA4QQrcur9kD5-BzicCd2dy5Cykjeha-NdFof4Tij3oJXAMjt1ZN-9Sb5zdR9cofCD6te92vQXTRDH4LsfCmHTT8bWOA-_ZvFtM4ReXnPD8tTKZCDc5tsH6YcIBb3WoLcr66fsQNsmtTtdeHWvj_MLM2DHdZP1yN78rBOMPqQka2Nc-UZGorzrNG74x6pX4'
  },
  {
    product_id: '6',
    name: 'Gourmet Coffee Beans',
    category_id: 'c6',
    category: { category_id: 'c6', name: 'Pantry' },
    cost_price: 7.0,
    unit_price: 12.5,
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBYR-Lv-l7fxSFbqIG8iFP7nqun7XFNLR7NhSFluxXYskAEo4uN4mTQJD7ep7yS24JHZgYRj7ditNKsVLYmdm8zprB9Tql3kvKgnfjKs9T2cxrHYbPU3mSijySkqBuLtGWtbo9J9T9_rJhQ-7w1ucDq183WeIUo-PmSTwyKt_KEDuUNZyQZSdnvmkh-iuIslO8pFaRyZ5M-l9horXRJ3wevhVK1H_cBAjpOCLYZ5jXzuQVvV9_QzyOH3CM6V8y_DrBnEmVYagAjpLw'
  },
];
